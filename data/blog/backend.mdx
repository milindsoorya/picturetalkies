...
- [Backend Basics](/review/backend#backend-basics)
- [Do You Even Need a Database?](/review/backend#do-you-even-need-a-database)
- [Low Code Solutions](/review/backend#low-code-solutions)
- [Terms To Understand](/review/backend#terms-to-understand)
  - [SQL / NoSQL](/review/backend#sql--nosql)
  - [GraphQL / REST](/review/backend#graphql--rest)
  - [Authentication / Authorization](/review/backend#authentication--authorization)
  - [Hosted / Self-Hosted](/review/backend#hosted--self-hosted)
  - [Serverless](/review/backend#serverless)
  - [Data Modeling](/review/backend#data-modeling)
- [Levels of Abstraction](/review/backend#levels-of-abstraction)
- [List of Services](/review/backend#list-of-services)
  - [Backend (as a Service)](/review/backend#backend-as-a-service)
    - [Firebase](/review/backend#firebase)
    - [Hasura](/review/backend#hasura)
  - [Build Your Own Backend](/review/backend#build-your-own-backend)
    - [Prisma](/review/backend#prisma)
  - [Others](/review/backend#others)
- [Should You Use a CMS?](/review/backend#should-you-use-a-cms)
- [Starting From Scratch](/review/backend#starting-from-scratch)
- [Conclusion / Resources](/review/backend#conclusion--resources)
