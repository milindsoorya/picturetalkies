    ...
    >
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          {`Picture Talkies - A Community for Cinephiles, is a small website created by film buffs for the film buffs.
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="px-4 py-2 border-2 border-gray-300 dark:border-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
          />
          <svg
